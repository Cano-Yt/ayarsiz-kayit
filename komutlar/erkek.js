...
let isim = args[1]
let yaş = args[2]
if(!message.author.roles.cache.has("816210424110383124")) return message.channel.send(`<a:x_:818861889400209419> Bu komutu kullanabilmek için \`${message.guild.roles.cache.get("816210424110383124").name}\` Rolüne sahip olmalısın`)
